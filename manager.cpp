    ...
    ui(new Ui::manager)
{
    ...
    ui->setupUi(this);
    connect(ui->student_ID,SIGNAL(cellClicked(int,int)),this,SLOT(on_markcoursewidget_click(int,int)));
    // original
    ...
    // my test of button names
    connect(ui->student_add_button, SIGNAL(clicked()), this, SLOT(on_searchbuttonmark_click());
    connect(ui->sec_add_button, SIGNAL(clicked()), this, SLOT(on_searchbuttonselect_click()));
    connect(ui->teacher_add_button, SIGNAL(clicked()), this, SLOT(on_refresh_click()));
    // ....
